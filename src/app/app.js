var appMain = angular.module('app', ['ngMessages', 'ngRoute']); // Use array to declare outside dependencies like ngMessages
...
appMain.controller('newController', ['$scope', '$log', function($scope, $log) {    
